...
class Nurse(BaseModel):
    ...
    sys_user_id: Optional[str] = None  # long globally unique id
    nurse_id: Optional[str] = None  # short id unique for doctor assist system 
    doctor_id: Optional[str] = None  # ID of the doctor the nurse is under
    email: Optional[str] = None
...
#################clinical source for tracking the clincical add from the website and defferent sources######################

class ClinicUserSource(BaseModel):
    name: str
    address: Optional[str]
    headquarters: Optional[str]
    username: str
    ...
    no_of_beds: int
    country_code: str
    hospital_user_type: str
    created_at: datetime
    source: str  # The new source field

###########end of clinical source for tracking the clincical add from the website and defferent sources######################
