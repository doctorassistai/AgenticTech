    ...
    const loadNotification = async () => {
      try {
        const res = await fetch(
          `${API_BASE_URL}hms/users/speciality/during-get-clinical-configuration/${doctorId}?consultation_phase=DURING_CONSULTATION`
        );
        ...
        for (const item of config.data) {
          ...
          const exec = await fetch(
            `${API_BASE_URL}hms/users/speciality/execute-specialty-feature-db`,
            {
              method: "POST",
