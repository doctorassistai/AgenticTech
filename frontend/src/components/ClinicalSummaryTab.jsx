...
const SPECIALTY_SUMMARY_GET_URL = (patientId) => `${API_BASE_URL}hms/users/data/context/surgical-oncology-summary/${patientId}`;
const SPECIALTY_SUMMARY_POST_URL = `${API_BASE_URL}hms/users/ai-legacy/surgical-oncology-summary`;
