...
import {
  ...
  Calendar, Stethoscope, LogOut, Building, Clipboard, BarChart3, Settings,
  Bell, Search, FileText, User, ChevronRight
} from 'lucide-react';
...
function DoctorUpload() {
  ...
  const [terminalLogs, setTerminalLogs] = useState([
    '> System initialized...',
    '> Ready to process doctor records',
  ]);
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}hms/users/data/system/upload_doctors_excel?hospital_id=${hospitalId}`,
        {
          method: 'POST',
          body: formData,
          credentials: "include",
      ...
      setDoctors(result.all_data);
      addLog(`✓ Received ${result.all_data.length} records from backend`);
  ...
  const navSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Add Doctor via Excel", icon: <FileText size={14} />, action: handleAddExcel, active: true },
  ...
  return (
    <div style={S.layout}>
      ...
      <main style={S.main}>
        <div style={S.topBar}>
          <div>
            <p style={S.topBarTitle}>Doctor Records Upload</p>
            <p style={S.topBarSub}>Upload Excel files to process doctor records</p>
          </div>
        ...
        <div style={S.body}>
          ...
          <h1 style={S.pageTitle}>Bulk Doctor Upload</h1>
              ...
              <div style={S.grid2}>
                ...
                <div>
                  <div style={S.field}>
                    ...
                    >
                      ...
                      <p style={S.uploadSubtext}>or click to browse</p>
                      {selectedFile && (
                ...
                <div style={S.terminal}>
                  <div style={S.terminalHeader}>
                    ...
                    <h3 style={S.terminalTitle}>Extracted Data</h3>
                  </div>
